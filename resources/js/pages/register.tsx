        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-100 px-6 py-12">
            <div className="w-full max-w-md rounded-3xl border border-gray-100 bg-white p-10 shadow-xl">
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                    ...
                    <button disabled={processing} className={`${processing ? "cursor-not-allowed" : " cursor-pointer"} m-2 w-full rounded-xl bg-blue-600 py-4 font-semibold text-white shadow-lg transition-all hover:bg-blue-700 active:scale-95`}>
