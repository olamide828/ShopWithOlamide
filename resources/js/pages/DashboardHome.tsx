...
import { FaBox, FaUsers, FaChartLine, FaPlus, FaClock, FaArrowRight } from 'react-icons/fa';
    ...
    <div className="space-y-8 max-w-full">
      ...
      <header className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="text-sm text-gray-500">Real-time metrics for ShopWithOlamide.</p>
        </div>
        <Link
          href="/admin/products"
          className="flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-6 py-2.5 font-semibold text-white shadow-md transition hover:bg-indigo-700"
        >
          <FaPlus /> Add Product
        </Link>
      </header>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm lg:col-span-2">
          <h2 className="mb-6 text-lg font-bold text-gray-800">Recent Activity</h2>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
          ...
          <div className="space-y-3">
            <QuickLink href="/admin/manage-users" label="Manage User Access" />
            <QuickLink href="/admin/products" label="Inventory Control" />
...
const QuickLink = ({ href, label }) => (
  ...
  >
    {label}
    <FaArrowRight className="text-[10px] opacity-0 group-hover:opacity-100 transition-all" />
  </Link>
);
