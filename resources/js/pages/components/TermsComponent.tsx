  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900">
        <div className="absolute left-[-60px] top-[-60px] h-72 w-72 rounded-full bg-purple-500/20 blur-3xl" />
        <div className="absolute bottom-[-100px] right-[-100px] h-80 w-80 rounded-full bg-indigo-500/15 blur-3xl" />

        <div className="relative mx-auto max-w-6xl px-6 py-24 lg:px-12">
          <div className="max-w-3xl">
            <span className="inline-flex rounded-full border border-purple-400/30 bg-purple-500/10 px-4 py-1 text-sm font-semibold uppercase tracking-[0.25em] text-purple-300">
              Legal Agreement
            </span>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              These Terms and Conditions govern your use of our platform. Please read them
              carefully before creating an account, making purchases, or using any of our
              services.
            </p>
          ...
          <div className="space-y-8">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
              ...
              <p className="mt-4 text-base leading-8 text-slate-300">
                ...
                understood, and agreed to these Terms and Conditions. These rules exist to
                protect both our users and the integrity of the platform.
              </p>
            </div>
